...
https://github.com/apache/incubator-groovy/blob/master/src/test/groovy/ClosureComposeTest.groovy[test
case].
...
https://github.com/apache/incubator-groovy/blob/master/subprojects/groovy-json/src/test/groovy/groovy/json/JsonSlurperTest.groovy[JsonSlurper
...
https://github.com/apache/incubator-groovy/blob/master/subprojects/groovy-json/src/test/groovy/groovy/json/JsonBuilderTest.groovy[JsonBuilder
tests].
