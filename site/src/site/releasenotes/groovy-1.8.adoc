...
The http://gpars.codehaus.org[GPars] project offers developers new
...
http://gpars.codehaus.org/[GPars website], read the
...
http://svn.codehaus.org/groovy/trunk/groovy/groovy-core/src/test/groovy/ClosureComposeTest.groovy[test
case].
...
http://svn.codehaus.org/groovy/branches/GROOVY_1_8_X/src/test/groovy/json/JsonSlurperTest.groovy[JsonSlurper
...
http://svn.codehaus.org/groovy/branches/GROOVY_1_8_X/src/test/groovy/json/JsonBuilderTest.groovy[JsonBuilder
tests].
