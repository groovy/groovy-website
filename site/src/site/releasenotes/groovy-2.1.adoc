...
detailed link:http://jira.codehaus.org/secure/ReleaseNote.jspa?projectId=12030&version=17007[JIRA release notes].
...
the link:http://beta.groovy-lang.org/docs/latest/html/documentation/#__code_delegatesto_code[@DelegatesTo documentation].
...
For more details take a look at
the link:http://docs.codehaus.org/display/GROOVY/Type+checking+extensions[type checking extensions documentation].
...
link:http://docs.codehaus.org/display/GROOVY/Meta-annotations[meta-annotations documentation].
...
link:http://docs.codehaus.org/display/GROOVY/Advanced+compiler+configuration[advanced compiler configuration documentation].
