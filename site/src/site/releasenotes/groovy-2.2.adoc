...
new link:http://jira.codehaus.org/browse/GROOVY-4993[@Memoized annotation].
...
new link:http://jira.codehaus.org/browse/GROOVY-6076[DelegatingScript].
...
closure delegation
strategies, link:http://jira.codehaus.org/browse/GROOVY-6134[works with generics token types] as well.
...
the link:http://jira.codehaus.org/browse/GROOVY-6043[precompiled class implementing your extension]:
...
events: link:http://jira.codehaus.org/browse/GROOVY-6039[ambiguousMethods] and link:http://jira.codehaus.org/browse/GROOVY-6044[incompatibleReturnType]. 
...
* support for link:http://jira.codehaus.org/browse/GROOVY-6073[code completion] in various places, like imports, package names, class names,
variable names, parameter names, keywords, etc.
* a link:http://jira.codehaus.org/browse/GROOVY-6150[doc command] allows you
...
* you can link:http://jira.codehaus.org/browse/GROOVY-6145[complete file names] inside strings, particularly handy for your scripting tasks where
