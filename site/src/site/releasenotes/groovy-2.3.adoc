...
(link:http://jira.codehaus.org/browse/GROOVY-6570[GROOVY-6570]).
...
(link:https://jira.codehaus.org/browse/GROOVY-6484[GROOVY-6484]).
...
(link:http://jira.codehaus.org/browse/GROOVY-6649[GROOVY-6649]).
...
(link:http://jira.codehaus.org/browse/GROOVY-6329[GROOVY-6329]).
...
(link:http://jira.codehaus.org/browse/GROOVY-6592[GROOVY-6592]) to indicate
...
(link:http://jira.codehaus.org/browse/GROOVY-6585[GROOVY-6585]
and link:http://jira.codehaus.org/browse/GROOVY-6615[GROOVY-6615]).
...
See link:http://jira.codehaus.org/browse/GROOVY-6377[GROOVY-6377] and
...
(link:http://jira.codehaus.org/browse/GROOVY-6588[GROOVY-6588]).
...
(link:http://jira.codehaus.org/browse/GROOVY-6383[GROOVY-6383]).
...
(link:http://jira.codehaus.org/browse/GROOVY-4639[GROOVY-4639]) have been
...
(link:http://jira.codehaus.org/browse/GROOVY-6399[GROOVY-6399])
* completion for properties
(link:http://jira.codehaus.org/browse/GROOVY-6395[GROOVY-6395])
...
(link:https://jira.codehaus.org/browse/GROOVY-6303[GROOVY-6303], although
...
with link:http://jira.codehaus.org/browse/GROOVY-6459[GROOVY-6459].
...
* http://jira.codehaus.org/browse/GROOVY-6685[GROOVY-6685]
* http://jira.codehaus.org/browse/GROOVY-6683[GROOVY-6683]
* http://jira.codehaus.org/browse/GROOVY-6682[GROOVY-6682]
* http://jira.codehaus.org/browse/GROOVY-6678[GROOVY-6678]
* http://jira.codehaus.org/browse/GROOVY-6621[GROOVY-6621]

With the new default methods on interfaces in JDK 8, there was
particularly one,
a link:http://jira.codehaus.org/browse/GROOVY-6465[List#sort(Comparable) method], which *conflicted with one of the GDK*,
so we had to remove ours to stay compliant with JDK 8.

We fixed a link:http://jira.codehaus.org/browse/GROOVY-6456[race condition in AbstractHttpServler#applyResourceNameMatcher]
