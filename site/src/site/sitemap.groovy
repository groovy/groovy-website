...
documentation {
    groovyDocumentationVersions([
            ...
            '2.4.0', '2.4.1', '2.4.2', '2.4.3', '2.4.4', '2.4.5', '2.4.6', '2.4.7', '2.4.8', '2.4.9', '2.4.10', '2.4.11', '2.4.12', '2.4.13', '2.4.14',
            '2.5.0-alpha-1', '2.5.0-beta-1', '2.5.0-beta-2', '2.5.0-beta-3',
            '2.6.0-alpha-1', '2.6.0-alpha-2', 
            '3.0.0-alpha-1'
...
downloads {
    ...
    distribution('Groovy 2.6') {
        ...
        version('2.6.0-alpha-2') {
            stable false
            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.6.0-alpha-2-installer.exe'
        }
    }
    distribution('Groovy 2.5') {
        ...
        version('2.5.0-beta-2') {
            stable false
            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.5.0-beta-2-installer.exe'
        }
    }
    distribution('Groovy 2.4') {
        ...
        version('2.4.14') {
            stable true
//            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.4.14-installer.exe'
        }
        version('2.4.13') {
            stable true
            windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.4.13-installer.exe'
        }
    }
}
