...
documentation {
    groovyDocumentationVersions([
            ...
            '2.5.0-alpha-1', '2.5.0-beta-1', '2.5.0-beta-2', '2.5.0-beta-3', '2.5.0-rc-1', '2.5.0-rc-2',
...
downloads {
    ...
    distribution('Groovy 2.5') {
        ...
        version('2.5.0-rc-2') {
            stable false
            //windowsInstaller 'https://dl.bintray.com/groovy/Distributions/groovy-2.5.0-rc-2-installer.exe'
        }
        version('2.5.0-rc-1') {
            stable false
