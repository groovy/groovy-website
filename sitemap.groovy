documentation {
    section('Getting started','fa-graduation-cap') {
        ...
        item 'Differences with Java', 'differences', 'core-differences'
        ...
        item 'Testing guide', 'testing', 'core-testing'
        item 'Domain-Specific Languages', 'dsls', 'core-dsls'
        item 'Security', 'security', 'security'
        item 'Design patterns in Groovy', 'design-patterns', 'core-design-patterns'
    }

    section('Groovy module guides', 'fa-cubes') {
        item 'Parsing and producing JSON', 'json', 'json'
