                    ...
                    div(class: 'row-fluid') {
                        ...
                        div(class: 'col-lg-8 col-lg-pull-0') {
                            ...
                            article {
                                ...
                                p {
                                    yield 'Since Groovy 2.0.0 we follow the '
                                    a(href: "http://semver.org/", 'semantic version scheme')
                                    yield '. This means the next minor version after 2.0.0 is 2.1.0, the first bugfix version after 2.0 is 2.0.1 and the next major version will be 3.0.0.'
                                }
